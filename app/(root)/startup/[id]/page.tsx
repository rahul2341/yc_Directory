  ...
  return (
    <>
      ...
      <section className='section_container'>
        <img src={post?.image} alt='image' className='w-full max-h-[40dvh] object-cover object-center rounded-xl' />

        <div className="space-y-5 mt-10 max-w-4xl mx-auto">
          <div className="flex-between gap-5">

            <Link href={`/user/${post.author?._id}`} className='flex ga-2 items-center mb-3'>
